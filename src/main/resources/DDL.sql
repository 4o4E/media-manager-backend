...
(
    id          BIGINT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT '唯一id',
    ...
    create_time TIMESTAMP       NOT NULL COMMENT '创建于',
    update_by   BIGINT UNSIGNED NOT NULL COMMENT '修改者',
    update_time TIMESTAMP       NOT NULL COMMENT '修改于'
) COMMENT '用户'
    CHARSET UTF8MB4
...
(
    ...
    expire_time TIMESTAMP       NOT NULL COMMENT '会话过期时间, 过期后应重登',
...
(
    ...
    parent      BIGINT UNSIGNED NULL COMMENT '父菜单id',
...
CREATE TABLE sys_user_forget_password
(
    id          BIGINT UNSIGNED    NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT '唯一id',
    user_id     BIGINT UNSIGNED    NOT NULL COMMENT '用户id',
